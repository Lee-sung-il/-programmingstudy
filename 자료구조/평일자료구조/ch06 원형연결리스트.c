...
//{
//	//1 노드생성(NULL체크) + 데이터값 넣기 + 링크NULL 초기화
//	Node* new = (Node*)malloc(sizeof(Node));
//	if (new == NULL)
//	{
//		printf("동적할당 실패!\n");
...
//
//	//2 존재 노드가 O -> 3 작업 수행
//	Node* cur = plist->tail->next; // 첫노드 위치를 검색 시작점으로 지정
//	for (int i = 0; i < plist->NodeCnt; i++)
//	{
//		if (cur->data == target)
//		{
...
//	plist->NodeCnt--;// 노드개수 1감소
//
//	if (plist->tail==del) //삭제노드가 끝노드인 경우
//	{
